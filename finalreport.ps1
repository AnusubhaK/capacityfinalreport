function Get-ClusterCapacityCheck {
    ...
    #Get-Cluster | Get-ClusterCapacityCheck | Select-Object Cluster,ClusterFreeDiskspaceGB,ClusterCPUUsageMHz,ClusterCPUTotalMHz,ClusterFreeCPUGHz,ClusterFreeCPUGHz_PerCore,ClusterTotalMemory,ClusterUsedMemory,ClusterFreeMemory
